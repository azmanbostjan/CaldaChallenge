...
-- Orders table
DROP TRIGGER IF EXISTS trg_orders_updated_at ON dbo.orders;
...
-- Order items table
DROP TRIGGER IF EXISTS trg_order_items_updated_at ON dbo.order_items;
...
-- Item history table
DROP TRIGGER IF EXISTS trg_item_history_updated_at ON dbo.item_history;
