...
-- Insert users with correct enum values for user_status
INSERT INTO public.seed_data (type, payload)
VALUES
  ('user', '{"email": "azmanbostjan+1@gmail.com", "password": "password123", "role": "Active"}'::jsonb),
  ('user', '{"email": "azmanbostjan+2@gmail.com", "password": "password123", "role": "Active"}'::jsonb),
  ('user', '{"email": "azmanbostjan+3@gmail.com", "password": "password123", "role": "Active"}'::jsonb),
  ('user', '{"email": "azmanbostjan+admin@gmail.com", "password": "password123", "role": "Active"}'::jsonb),
  ('user', '{"email": "azmanbostjan+4@gmail.com", "password": "password123", "role": "Active"}'::jsonb);

-- Insert catalog items with correct enum for item_status
INSERT INTO public.seed_data (type, payload)
VALUES
...
-- Insert orders with correct enum for order_status
INSERT INTO public.seed_data (type, payload)
VALUES
  ('order', '{
